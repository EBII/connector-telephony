...
class ServerAction(models.Model):
    ...
    mobile = fields.Char(string='Mobile No', help="Provides fields that "
    ...
    sms_server = fields.Many2one(comodel_name='sms.smsclient',
                                 string='SMS Server',
                                 help='Select the SMS Gateway configuration'
                                 ' to use with this action')
    sms_template_id = fields.Many2one(comodel_name='email.template',
                                      string='SMS Template',
